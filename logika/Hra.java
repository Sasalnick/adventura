...
public class Hra implements IHra {
    ...
    public Hra() {
        ...
        platnePrikazy.vlozPrikaz(new PrikazModriCerveny(herniPlan));
    ...
    public String vratUvitani() {
        return "**************************************************************************\n"+
               "Vítej!\n" +
               "Jsi princezna Anabelle\n" +
               " Vaše království musí být zachráněno před zlými duchy!\n"+
               "Musíš projít zkoumání.\n" +
                "Musíte ukázat svou vynalézavost, sílu a přátelskost.\n" +
               "Hodně štěstí!\n" +
